...
# Fix for MacOS.
mkdir -p glow/gl/KHR/ && cp supporting_files/khrplatform.h glow/gl/KHR/khrplatform.h
mkdir -p glow/gles/KHR/ && cp supporting_files/khrplatform.h glow/gles/KHR/khrplatform.h
#-